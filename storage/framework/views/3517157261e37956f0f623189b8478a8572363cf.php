            ...
            <table class="table table-bordered" id="table_index">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(route('admin_post.category_edit', $item->id)); ?>" title=""><b><?php echo e($item->name); ?></b></a>
                            <div>
                                <a class="text-dark" href="<?php echo e(route('post.single', ['slug' => $item->slug])); ?>" target="_blank"><?php echo e(route('post.single', ['slug' => $item->slug])); ?></a>
                            </div>
                        </td>
                        <td class="text-center">
                            <?php if($item->image): ?>
                            <img src="<?php echo e(asset($item->image)); ?>" height="80">
                            <?php endif; ?>
                        </td>
                        <td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/deviceaz/gtcplatform.exproweb.com/resources/views/admin/post-category/index.blade.php ENDPATH**/ ?>