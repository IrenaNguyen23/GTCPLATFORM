<?php
    $transportation = 'Đường hàng không';
    if(empty($products))
    {
...
<?php else: ?>
    ...
    <?php echo $__env->make($view, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>
<?php /**PATH /home/deviceaz/gtcplatform.exproweb.com/resources/views/theme/product/van-chuyen/duong-hang-khong.blade.php ENDPATH**/ ?>