    ...
    <div class="search-feature">
        <form action="<?php echo e($url_action_filter); ?>" class="form-inline form-search" id="form-search">
            ...
            <div class="input-search input-w-auto icon">
                ...
                <input type="search" name="keyword" class="form-control" value="<?php echo e(request('keyword')); ?>" placeholder="Nhập loại dịch vụ" />
            </div>
...
</div><?php /**PATH /home/deviceaz/gtcplatform.exproweb.com/resources/views/theme/product/dich-vu-khac/filter-top.blade.php ENDPATH**/ ?>