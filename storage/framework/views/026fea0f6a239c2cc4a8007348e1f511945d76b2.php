    ...
    <div class="search-feature">
        <form action="<?php echo e($url_action_filter); ?>" class="form-inline form-search" id="form-search">
            ...
            <div class="input-search input-w-auto icon">
                ...
                <input type="search" name="keyword" class="form-control" value="<?php echo e(request('keyword')); ?>" placeholder="Tìm kiếm" />
            </div>

            <div class="input-search">
                <select class="form-control seaport" name="country">
                    <option value="">Vị trí nhà xưởng</option>
                </select>
            </div>
            <input type="submit" value="TÌM KIẾM" class="productSearch-btn">
        </form>
    </div>
</div><?php /**PATH /home/deviceaz/gtcplatform.exproweb.com/resources/views/theme/product/kho-bai/filter-top.blade.php ENDPATH**/ ?>