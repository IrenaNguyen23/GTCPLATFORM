                                        ...
                                        <div class="col-lg-12">
                                            <div class="optionItem">
                                                <div class="input-boder ">
                                                    ...
                                                    <input type="text" class="form-control input-value" name="title" value="<?php echo e(old('title')); ?>" required>
                                                </div>
                                            </div>
                                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make($templatePath.'.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/deviceaz/gtcplatform.exproweb.com/resources/views/theme/product/contact.blade.php ENDPATH**/ ?>