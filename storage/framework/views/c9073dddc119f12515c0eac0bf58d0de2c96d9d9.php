...
<form action="<?php echo e($url_post); ?>" method="POST" id="frm-create-page" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <?php echo $__env->make('admin.partials.post_category', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/deviceaz/gtcplatform.exproweb.com/resources/views/admin/post/single.blade.php ENDPATH**/ ?>