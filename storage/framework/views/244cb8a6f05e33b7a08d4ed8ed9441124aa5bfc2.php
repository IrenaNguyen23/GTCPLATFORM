<div class="shop-sidebar">
    <div class="menu-nav">
        <div class="pres-archive" data-bs-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="true" aria-controls="multiCollapseExample1">
            <div class="name-archive text-uppercase">Ngành tuyển dụng</div>
    ...
    <?php if ($__env->exists($templatePath .'.product.filter-option',['id' => 112, 'type' => 'price'])) echo $__env->make($templatePath .'.product.filter-option',['id' => 112, 'type' => 'price'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div><?php /**PATH /home/deviceaz/gtcplatform.exproweb.com/resources/views/theme/product/viec-lam/filter-right.blade.php ENDPATH**/ ?>